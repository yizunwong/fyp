  ...
  return (
    <View className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 mb-4">
      <View className="flex-row items-center gap-3 mb-4">
        <View className="flex-1 flex-row items-center gap-2 bg-white dark:bg-gray-700 rounded-lg px-3 py-2 shadow-sm">
            ...
            >
              <Text
                className={`text-xs font-semibold ${
                  roleFilter === role.key ? "text-purple-700 dark:text-purple-400" : "text-gray-700 dark:text-gray-300"
                }`}
              >
                {role.label}
              </Text>
