/*
  ...
  - You are about to drop the column `certifications` on the `ProgramEligibility` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "ProgramEligibility" DROP COLUMN "certifications",
